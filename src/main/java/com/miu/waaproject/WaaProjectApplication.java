...
public class WaaProjectApplication {
    ...
    CommandLineRunner run(UserService userService, ProductService productService, SellerService sellerService) {
        return args -> {
            ...
            // Create products
            productService.saveProduct(new Product(null, "Banana","The best banana ever",4.80, true, "admin@email.com"));
            ...
            productService.saveProduct(new Product(null, "MacBook Pro","The best computer ever",1000, true, "admin@email.com"));
